(function($) {
  ...
  $(function() {
    ...
    if ($("#serviceSaleProgress").length) {
      ...
      let linearGradient = '<defs><linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0%" gradientUnits="userSpaceOnUse"><stop offset="20%" stop-color="#6200EE"/><stop offset="50%" stop-color="#6200EE"/></linearGradient></defs>';
